...
create: function() {
this.inherited(arguments);
var e = location.origin + "/defaults", t = (new enyo.Ajax({
url: e,
method: "GET",
handleAs: "json",
...
contentType: "application/json",
postBody: i
})).response(this, "okDoIt").error(this, "errorAjax").go();
return !0;
},
okDoIt: function(e, t) {
typeof t == "object" && t.ok ? this.$.result.setContent("Update successful") : this.$.result.setContent("App Error:" + enyo.json.stringify(t));
},
errorAjax: function(e, t) {
this.$.result.setContent("Error:" + enyo.json.stringify(t));
}
});
